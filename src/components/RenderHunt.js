...
const Scan = () => {
	...
	return (<div style={{ background: "#321e43", }}>
		<Bar />
		<div style={{ display: "flex", justifyContent: 'center', alignItems: "center", margin: "2rem", columnGap: "8rem", padding: "2rem", flexDirection: "column" }}>
			<button onClick={set} className="btn btn-primary" style={{ marginBottom: "4rem", textAlign: "center", fontSize: "2rem", fontWeight: "bold", color: "#fff", padding: "2rem", width: "20%" }}> Drop here </button>
